...
#if defined(MBEDTLS_SSL_PROTO_SSL3)
void ssl_calc_verify_ssl( mbedtls_ssl_context *ssl, unsigned char mtls_hash[36] )
{
    mbedtls_md5_context md5;
    mbedtls_sha1_context sha1;
    ...
    mbedtls_md5_finish( &md5, mtls_hash );
    
    mbedtls_md5_starts( &md5 );
    mbedtls_md5_update( &md5, ssl->session_negotiate->master, 48 );
    mbedtls_md5_update( &md5, pad_2, 48 );
    mbedtls_md5_update( &md5, mtls_hash,  16 );
    mbedtls_md5_finish( &md5, mtls_hash );
    
    mbedtls_sha1_update( &sha1, ssl->session_negotiate->master, 48 );
    mbedtls_sha1_update( &sha1, pad_1, 40 );
    mbedtls_sha1_finish( &sha1, mtls_hash + 16 );
    
    mbedtls_sha1_starts( &sha1 );
    mbedtls_sha1_update( &sha1, ssl->session_negotiate->master, 48 );
    mbedtls_sha1_update( &sha1, pad_2, 40 );
    mbedtls_sha1_update( &sha1, mtls_hash + 16, 20 );
    mbedtls_sha1_finish( &sha1, mtls_hash + 16 );
    
    MBEDTLS_SSL_DEBUG_BUF( 3, "calculated verify result", mtls_hash, 36 );
...
#if defined(MBEDTLS_SSL_PROTO_TLS1) || defined(MBEDTLS_SSL_PROTO_TLS1_1)
void ssl_calc_verify_tls( mbedtls_ssl_context *ssl, unsigned char mtls_hash[36] )
{
    mbedtls_md5_context md5;
    mbedtls_sha1_context sha1;
...
#if defined(MBEDTLS_SSL_PROTO_TLS1_2)
#if defined(MBEDTLS_SHA256_C)
void ssl_calc_verify_tls_sha256( mbedtls_ssl_context *ssl, unsigned char mtls_hash[32] )
{
    ...
    mbedtls_sha256_finish( &sha256, mtls_hash );
    
    MBEDTLS_SSL_DEBUG_BUF( 3, "calculated verify result", mtls_hash, 32 );
    MBEDTLS_SSL_DEBUG_MSG( 2, ( "<= calc verify" ) );
...
#if defined(MBEDTLS_SHA512_C)
void ssl_calc_verify_tls_sha384( mbedtls_ssl_context *ssl, unsigned char mtls_hash[48] )
{
    ...
    mbedtls_sha512_finish( &sha512, mtls_hash );
    
    MBEDTLS_SSL_DEBUG_BUF( 3, "calculated verify result", mtls_hash, 48 );
    MBEDTLS_SSL_DEBUG_MSG( 2, ( "<= calc verify" ) );
 ...
 */
mbedtls_md_type_t mbedtls_ssl_md_alg_from_hash( unsigned char mtls_hash )
{
    switch( mtls_hash )
    {
